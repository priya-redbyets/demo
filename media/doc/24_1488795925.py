...
def UpdateClass(request, class_id):
    ...
    return render(request, "class_update.html" ,{'ClassDetailsForm':ClassDetails_obj}) 
...
#         print Subject1.subject
     ...
     return render(request, "update_student.html" ,{'StudentDetailsForm':StudentDetailsForm1 ,'ParentsDetails':ParentDetail ,'subject':new_list ,'ClassDetail':ClassDetail ,'female':female,'male':male ,"modelDict":modelDict }) 
