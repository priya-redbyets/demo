...
urlpatterns = [
    ...
    url(r'^classAcedemicyear/$', views.ClassAcedemicyear, name='classAcedemicyear'),
     ...
     url(r'^viewMultiSectionList/$',views.ViewMultiSectionList, name='viewMultiSectionList'),
     url(r'^class_academic_mapping/$', views.ClassAcedemicMapping, name='class_academic_mapping'),
     url(r'^viewmappedAcademicClass/$', views.ViewMappedAcademicClass, name='viewmappedAcademicClass'),
    ...
    ######################  Class Subject MAPPING URLS ##############################
     ...
     ######################  Role User MAPPING URLS ########################################
      ...
      ######################  Teacher Subject MAPPING URLS ########################################
        ...
        url(r'^viewSectionDetails/$',views.ViewSectionDetail, name='viewSectionDetails'),
        url(r'^viewTeacherDetails/$',views.ViewTeacherDetail, name='viewTeacherDetails'),
        url(r'^viewClassDetails/$',views.ViewClassDetail, name='viewClassDetails'),
