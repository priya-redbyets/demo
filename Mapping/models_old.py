...
class TeacherSubjectRelation(models.Model):
    teacher_name = models.ForeignKey(StaffDetails, related_name='teacher_name', db_column='teacher_name', blank=True, null=True)
    subject_name = models.ManyToManyField(Subject)
    assistant_teacher_name = models.ForeignKey(StaffDetails, related_name='assistant_teacher_name', db_column='assistant_teacher_name', blank=True, null=True)
...
class AssistantteacherSubjectRelation(models.Model):
    assistantteacher_name = models.ManyToManyField(StaffDetails)
    subject_name = models.ManyToManyField(Subject)
...
class AssiteacherSubjectRelationSubjectName(models.Model):
...
class SupervisorClassRelation(models.Model):
    supervisor_name = models.ManyToManyField(StaffDetails)
    class_name =  models.ManyToManyField(ClassDetails)
    class Meta:
        managed = False
...
class Religion(models.Model):
    religion_name = models.CharField(max_length=45, blank=True, null=True)
...
class Nationality(models.Model):
    nationality_name = models.CharField(max_length=45, blank=True, null=True)
