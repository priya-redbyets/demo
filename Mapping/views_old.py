...
def ViewFilteredStudent(request): 
    ...
    if class_name and section_name and religion and nationality:
        ...
        for obj in v :
             ...
             if not StudentDetail in studentDetail1:
                 
              studentDetail1.append(StudentDetail)
    ...
    if class_name and section_name and religion:
        ...
        for obj in v :
             ...
             if not StudentDetail in studentDetail1:
              ...
              studentDetail1.append(StudentDetail)
        print"studentDetailstudentDetailstudentDetail>>>>>>>>>>>>>>>>>>>>>>>>",studentDetail1
        str_list2 = filter(None, studentDetail1) #
        print"str_liststr_liststr_liststr_liststr_list",str_list2
         
    if class_name and section_name and nationality:
        ...
        for obj in v :
             ...
             if not StudentDetail in studentDetail1:
              ...
              studentDetail1.append(StudentDetail)
        print"studentDetailstudentDetailstudentDetail>>>>>>>>>>>>>>>>>>>>>>>>",studentDetail1
        str_list3 = filter(None, studentDetail1) #
        print"str_liststr_liststr_liststr_liststr_list",str_list3
    ...
    if class_name and section_name:
        ...
        for obj in v :
            ...
            if not StudentDetail in studentDetail1:
             ...
             studentDetail1.append(StudentDetail)
        print"studentDetailstudentDetailstudentDetail>>>>>>>>>>>>>>>>>>>>>>>>",studentDetail1
        str_list4 = filter(None, studentDetail1) #
        print"str_liststr_liststr_liststr_liststr_list",str_list4
 
 
 
 
    
    if class_name and nationality:
        ...
        for obj in v :
            ...
            if StudentDetail != "":
                if not StudentDetail in studentDetail1:
                    ...
                    studentDetail1.append(StudentDetail)
        print"studentDetailstudentDetailstudentDetail>>>>>>>>>>>>>>>>>>>>>>>>",studentDetail1
        str_list5 = filter(None, studentDetail1) #
        print"str_liststr_liststr_liststr_liststr_list",str_list5
          
         
         
         
    if class_name and religion:
        ...
        for obj in v :
            ...
            if StudentDetail != "":
                if not StudentDetail in studentDetail1:
                    ...
                    studentDetail1.append(StudentDetail)
        print"studentDetailstudentDetailstudentDetail>>>>>>>>>>>>>>>>>>>>>>>>",studentDetail1
        str_list6 = filter(None, studentDetail1) #
        print"str_liststr_liststr_liststr_liststr_list",str_list6
    ...
    print " str_list5 str_list5 str_list5 str_list5", modelDict
    return JsonResponse(modelDict,safe=False)
