...
#         print Subject1.subject
     ...
     return render(request, "update_student.html" ,{'roleId':roleId ,'StudentDetailsForm':StudentDetailsForm1 ,'subjectopt':new_list1,'ParentsDetails':ParentDetail ,'ReligionDetail':ReligionDetail ,'NationalityDetail':NationalityDetail ,'subject':new_list ,'ClassDetail':ClassDetail ,'female':female,'male':male ,"modelDict":modelDict }) 
...
#    print "section_name",section_name
    ...
    StudentList = StudentDetails.objects.filter(class_name=class_name1,section_name=section_name1)
