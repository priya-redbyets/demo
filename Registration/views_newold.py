...
def ClassDetail(request):
    ...
    if roleId == 1:
        ...
        try:
         ClassTeacherMappingTeacherNameObj = ClassTeacherMappingTeacherName.objects.get(staffdetails_id = staffId)
        
         classteachermappingId =  ClassTeacherMappingTeacherNameObj.classteachermapping_id
