...
class ClassDetails(models.Model):
    ...
    def __unicode__(self):
        return u'{} - {}'.format(self.class_name, self.class_code)
...
class Sections(models.Model):
    ...
    def __unicode__(self):
        return u'{} - {}'.format(self.section, self.section_code)
...
class StudentDetails(models.Model):
    ...
    blood_group = models.CharField(max_length=45, blank=True, null=True)
    height = models.CharField(max_length=45, blank=True, null=True)
    weight = models.CharField(max_length=45, blank=True, null=True)
    under_medication = models.CharField(max_length=45, blank=True, null=True)
    allergic = models.CharField(max_length=45, blank=True, null=True)
...
class Subject(models.Model):
    ...
    def __unicode__(self):
        return u'{} - {}'.format(self.subject, self.code)
