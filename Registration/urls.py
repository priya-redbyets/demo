...
urlpatterns = [
    ...
    url(r'^view_class_section/$',views.ViewClassSection, name='view_class_section'),
    url(r'^viewSectionDetail/$',views.ViewSectionDetails, name='viewSectionDetail'),
    url(r'^view_student_medical_list/$',views.ViewStudentMedicalList, name='view_student_medical_list'),
    url(r'^add_medical/$',views.AddMedical, name='add_medical'),
    url(r'^save_medical_student/$',views.SaveMedicalStudent, name='save_medical_student'),
    url(r'^exportMedicalInfo/$',views.ExportMedicalInfo, name='exportMedicalInfo'),
    ...
    url(r'^ViewSectionDetailStudent/$',views.ViewSectionDetailStudent, name='ViewSectionDetailStudent'),
    ...
    url(r'^editParent/(?P<parent_id>[0-9]+)$', views.editParent, name='editParent'),
     url(r'^delete_student/$', views.DeleteStudent, name='delete_student'),
     url(r'^deactivate_user/(?P<user_id>[0-9]+)$',views.DeactivateUser, name='deactivate_user'),
     url(r'^exportMedicalInfo/$',views.ExportMedicalInfo, name='exportMedicalInfo'),
     url(r'^importMedicalInfo/$',views.ImportMedicalInfo, name='importMedicalInfo'),
