...
class StudentDetailsForm(forms.ModelForm):
   ...
   # section = forms.ModelChoiceField(queryset =  Sections  ,widget=forms.Select(attrs={'class':'form-control' , 'autocomplete': 'off'}))
    ...
    section = forms.ModelChoiceField(required=True ,queryset = Sections ,widget=forms.Select(attrs={'class':'form-control' , 'autocomplete': 'off'}))
...
# model = StudentDetails
    ...
    nationality = forms.ModelChoiceField(queryset = Nationality ,widget=forms.Select(attrs={'class':'form-control' , 'autocomplete': 'off'}))
    religion = forms.ModelChoiceField(queryset = Religion ,widget=forms.Select(attrs={'class':'form-control' , 'autocomplete': 'off'}))
...
class MedicalDetailsExcelForm(forms.ModelForm):
    ...
    excel = forms.FileField(required=False,label='Upload Photo' )
    class Meta:
        model = MedicalDetailsExcel
        fields =['excel']
