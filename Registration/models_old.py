...
class StudentDetails(models.Model):
    ...
    section_name = models.ForeignKey(Sections, models.DO_NOTHING, db_column='section_name', blank=True, null=True)
    ...
    nationality_name = models.ForeignKey(Nationality, models.DO_NOTHING, db_column='nationality_name', blank=True, null=True)
    religion_name = models.ForeignKey(Religion, models.DO_NOTHING, db_column='religion_name', blank=True, null=True)
