...
class TeacherSubjectRelationForm(forms.ModelForm):
    ...
    StaffDetail = StaffDetails.objects.none()  
    ...
    class Meta:
        ...
        fields = ['subject_name','teacher_name','assistant_teacher_name']
        
    def __init__(self,  *args,  **kwargs):
        super(TeacherSubjectRelationForm, self).__init__(*args, **kwargs) 
        self.fields['teacher_name'].queryset = StaffDetails.objects.none()
        if self.is_bound:
            self.fields['teacher_name'].queryset = StaffDetails.objects.filter(role_type=2) 
